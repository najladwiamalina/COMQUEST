...
**ComQuest: Interactive Quiz Website for Computer Science Students**

ComQuest is an interactive quiz platform designed for Computer Science students at IPB University. It provides structured quizzes by subject and chapter, along with a reward system to make learning more engaging.

## Features

1. Interactive quizzes by subject and chapter
2. Quiz results and answer review
3. Points and reward system
4. Item shop and website customization
5. Leaderboard
6. User authentication and dashboard
...
**Login Page**  
![Screenshot (2004)](https://github.com/Shidqnaya/COMQUEST/assets/149856214/50a49807-4d30-46eb-ad8d-a10a623ee3e8)
...
[View Project Report](https://docs.google.com/document/d/1jeWXTmaN5SYVYlkCpU2xs2xpi68rPUvT/edit?usp=sharing&ouid=115600189521791930981&rtpof=true&sd=true)

## Team

1. **Dwiamalina Qurratuain Najla**  
   UI/UX Design, Frontend Development, Documentation

2. **Muhammad Shidqi Abhinaya**  
   Backend Development

3. **Ryan Muhammad Syahran**  
   Backend Development
